"use strict";(globalThis.webpackChunkfront_js=globalThis.webpackChunkfront_js||[]).push([[4009],{94009(t,e,i){var r,o=i(12769),a=i(50832),s=i(48169),n=i(6056),c=i(86360),l=i(26742),p=i(78508),u=i(42733),d=i(90184),h=i(74496),g=i(70148),w=(i(60310),i(77616),i(45101),i(45090),i(35120)),y=i(54211),x=i(43121),m=(i(32565),i(18409),i(69807),i(26109));!function(t){t.approve="approved",t.bought="bought",t.borrow="borrowed",t.burn="burnt",t.cancel="canceled",t.claim="claimed",t.deploy="deployed",t.deposit="deposited",t.execute="executed",t.mint="minted",t.receive="received",t.repay="repaid",t.send="sent",t.sell="sold",t.stake="staked",t.trade="swapped",t.unstake="unstaked",t.withdraw="withdrawn"}(r||(r={}));var f=i(43494);i(36887),i(12851);const v=w.AH`
  :host > wui-flex {
    display: flex;
...
`;var b=function(t,e,i,r){var o,a=arguments.length,s=a<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,i,r);else for(var n=t.length-1;n>=0;n--)(o=t[n])&&(s=(a<3?o(s):a>3?o(e,i,s):o(e,i))||s);return a>3&&s&&Object.defineProperty(e,i,s),s};let $=class extends w.WF{constructor(){super(...arguments),this.images=[],this.secondImage={type:void 0,url:""}}render(){const[t,e]=this.images,i="NFT"===t?.type,r=i?"var(--wui-border-radius-xxs)":"var(--wui-border-radius-s)",o=(e?.url?"NFT"===e.type:i)?"var(--wui-border-radius-xxs)":"var(--wui-border-radius-s)";return this.style.cssText=`\n    --local-left-border-radius: ${r};\n    --local-right-border-radius: ${o};\n    `,w.qy`<wui-flex> ${this.templateVisual()} ${this.templateIcon()} </wui-flex>`}templateVisual(){const[t,e]=this.images,i=t?.type;return 2===this.images.length&&(t?.url||e?.url)?w.qy`<div class="swap-images-container">
        ${t?.url?w.qy`<wui-image src=${t.url} alt="Transaction image"></wui-image>`:null}
        ${e?.url?w.qy`<wui-image src=${e.url} alt="Transaction image"></wui-image>`:null}
      </div>`:t?.url?w.qy`<wui-image src=${t.url} alt="Transaction image"></wui-image>`:"NFT"===i?w.qy`<wui-icon size="inherit" color="fg-200" name="nftPlaceholder"></wui-icon>`:w.qy`<wui-icon size="inherit" color="fg-200" name="coinPlaceholder"></wui-icon>`}templateIcon(){let t,e="accent-100";return t=this.getIcon(),this.status&&(e=this.getStatusColor()),t?w.qy`
      <wui-icon-box
        size="xxs"
        iconColor=${e}
        backgroundColor=${e}
...
`;var k=function(t,e,i,r){var o,a=arguments.length,s=a<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,i,r);else for(var n=t.length-1;n>=0;n--)(o=t[n])&&(s=(a<3?o(s):a>3?o(e,i,s):o(e,i))||s);return a>3&&s&&Object.defineProperty(e,i,s),s};let A=class extends w.WF{constructor(){super(...arguments),this.type="approve",this.onlyDirectionIcon=!1,this.images=[],this.price=[],this.amount=[],this.symbol=[]}render(){return w.qy`
      <wui-flex>
        <wui-transaction-visual
          .status=${this.status}
    ...
    `}templateDescription(){const t=this.descriptions?.[0];return t?w.qy`
          <wui-text variant="small-500" color="fg-200">
            <span>${t}</span>
          </wui-text>
        `:null}templateSecondDescription(){const t=this.descriptions?.[1];return t?w.qy`
          <wui-icon class="description-separator-icon" size="xxs" name="arrowRight"></wui-icon>
          <wui-text variant="small-400" color="fg-200">
            <span>${t}</span>
          </wui-text>
        `:null}};A.styles=[m.W5,T],k([(0,y.MZ)()],A.prototype,"type",void 0),k([(0,y.MZ)({type:Array})],A.prototype,"descriptions",void 0),k([(0,y.MZ)()],A.prototype,"date",void 0),k([(0,y.MZ)({type:Boolean})],A.prototype,"onlyDirectionIcon",void 0),k([(0,y.MZ)()],A.prototype,"status",void 0),k([(0,y.MZ)()],A.prototype,"direction",void 0),k([(0,y.MZ)({type:Array})],A.prototype,"images",void 0),k([(0,y.MZ)({type:Array})],A.prototype,"price",void 0),k([(0,y.MZ)({type:Array})],A.prototype,"amount",void 0),k([(0,y.MZ)({type:Array})],A.prototype,"symbol",void 0),A=k([(0,f.E)("wui-transaction-list-item")],A),i(41497);const C=w.AH`
  :host > wui-flex:first-child {
    column-gap: var(--wui-spacing-s);
...
`;let D=class extends w.WF{render(){return w.qy`
    ...
    `}};D.styles=[m.W5,C],D=function(t,e,i,r){var o,a=arguments.length,s=a<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,i,r);else for(var n=t.length-1;n>=0;n--)(o=t[n])&&(s=(a<3?o(s):a>3?o(e,i,s):o(e,i))||s);return a>3&&s&&Object.defineProperty(e,i,s),s}([(0,f.E)("wui-transaction-list-item-loader")],D);var O=i(10152);const I=o.AH`
  :host {
    min-height: 100%;
  }

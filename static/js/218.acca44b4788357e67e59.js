"use strict";(globalThis.webpackChunkfront_js=globalThis.webpackChunkfront_js||[]).push([[218],{60218(e,t,i){i.r(t),i.d(t,{W3mBuyInProgressView:()=>M,W3mFundWalletView:()=>U,W3mOnRampProvidersView:()=>O,W3mOnrampFiatSelectView:()=>w,W3mOnrampTokensView:()=>j,W3mOnrampWidget:()=>J,W3mWhatIsABuyView:()=>F});var r=i(12769),o=i(50832),s=i(75880),a=i(95884),n=i(73337),c=i(51454),l=i(42733),u=i(96396),p=i(70148);i(60310),i(26509),i(45090),i(98585),i(46524);const d=r.AH`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`;var W=function(e,t,i,r){var o,s=arguments.length,a=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(a=(s<3?o(a):s>3?o(t,i,a):o(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let j=class extends r.WF{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=a.aG.state.purchaseCurrencies,this.tokens=a.aG.state.purchaseCurrencies,this.tokenImages=n.j.state.tokenImages,this.checked=c.o.state.isLegalCheckboxChecked,this.unsubscribe.push(a.aG.subscribe(e=>{this.selectedCurrency=e.purchaseCurrencies,this.tokens=e.purchaseCurrencies}),n.j.subscribeKey("tokenImages",e=>this.tokenImages=e),c.o.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{termsConditionsUrl:e,privacyPolicyUrl:t}=l.H.state,i=l.H.state.features?.legalCheckbox,o=Boolean(e||t)&&Boolean(i)&&!this.checked;return r.qy`
      <w3m-legal-checkbox></w3m-legal-checkbox>
      <wui-flex
        flexDirection="column"
        .padding=${["0","s","s","s"]}
...
`;var D=function(e,t,i,r){var o,s=arguments.length,a=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(a=(s<3?o(a):s>3?o(t,i,a):o(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let M=class extends r.WF{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=a.aG.state.selectedProvider,this.uri=T.x.state.wcUri,this.ready=!1,this.showRetry=!1,this.buffering=!1,this.error=!1,this.isMobile=!1,this.onRetry=void 0,this.unsubscribe.push(a.aG.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}))}disconnectedCallback(){this.intervalId&&clearInterval(this.intervalId)}render(){let e="Continue in external window";this.error?e="Buy failed":this.selectedOnRampProvider&&(e=`Buy in ${this.selectedOnRampProvider?.label}`);const t=this.error?"Buy can be declined from your side or due to and error on the provider app":"We’ll notify you once your Buy is processed";return r.qy`
      <wui-flex
    ...
    `}onTryAgain(){this.selectedOnRampProvider&&(this.error=!1,g.w.openHref(this.selectedOnRampProvider.url,"popupWindow","width=600,height=800,scrollbars=yes"))}tryAgainTemplate(){return this.selectedOnRampProvider?.url?r.qy`<wui-button size="md" variant="accent" @click=${this.onTryAgain.bind(this)}>
      ...
      Try again
    </wui-button>`:null}loaderTemplate(){const e=q.W.state.themeVariables["--w3m-border-radius-master"],t=e?parseInt(e.replace("px",""),10):4;return r.qy`<wui-loading-thumbnail radius=${9*t}></wui-loading-thumbnail>`}onCopyUri(){if(!this.selectedOnRampProvider?.url)return E.P.showError("No link found"),void y.I.goBack();try{g.w.copyToClopboard(this.selectedOnRampProvider.url),E.P.showSuccess("Link copied")}catch{E.P.showError("Failed to copy")}}};M.styles=B,D([(0,o.wk)()],M.prototype,"intervalId",void 0),D([(0,o.wk)()],M.prototype,"selectedOnRampProvider",void 0),D([(0,o.wk)()],M.prototype,"uri",void 0),D([(0,o.wk)()],M.prototype,"ready",void 0),D([(0,o.wk)()],M.prototype,"showRetry",void 0),D([(0,o.wk)()],M.prototype,"buffering",void 0),D([(0,o.wk)()],M.prototype,"error",void 0),D([(0,o.MZ)({type:Boolean})],M.prototype,"isMobile",void 0),D([(0,o.MZ)()],M.prototype,"onRetry",void 0),M=D([(0,p.EM)("w3m-buy-in-progress-view")],M);let F=class extends r.WF{render(){return r.qy`
      <wui-flex
        flexDirection="column"
    ...
    `:null}receiveTemplate(){return Boolean(this.features?.receive)?r.qy`
      ...
      ></wui-list-description>
    `:null}onBuyCrypto(){y.I.push("OnRampProviders")}onReceive(){y.I.push("WalletReceive")}onDepositFromExchange(){y.I.push("PayWithExchange")}};S([(0,o.wk)()],U.prototype,"namespace",void 0),S([(0,o.wk)()],U.prototype,"features",void 0),S([(0,o.wk)()],U.prototype,"remoteFeatures",void 0),U=S([(0,p.EM)("w3m-fund-wallet-view")],U),i(12965);const H=r.AH`
  :host {
    width: 100%;
  }
...
`;var L=function(e,t,i,r){var o,s=arguments.length,a=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(a=(s<3?o(a):s>3?o(t,i,a):o(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};let z=class extends r.WF{constructor(){super(),this.unsubscribe=[],this.type="Token",this.value=0,this.currencies=[],this.selectedCurrency=this.currencies?.[0],this.currencyImages=n.j.state.currencyImages,this.tokenImages=n.j.state.tokenImages,this.unsubscribe.push(a.aG.subscribeKey("purchaseCurrency",e=>{e&&"Fiat"!==this.type&&(this.selectedCurrency=this.formatPurchaseCurrency(e))}),a.aG.subscribeKey("paymentCurrency",e=>{e&&"Token"!==this.type&&(this.selectedCurrency=this.formatPaymentCurrency(e))}),a.aG.subscribe(e=>{"Fiat"===this.type?this.currencies=e.purchaseCurrencies.map(this.formatPurchaseCurrency):this.currencies=e.paymentCurrencies.map(this.formatPaymentCurrency)}),n.j.subscribe(e=>{this.currencyImages={...e.currencyImages},this.tokenImages={...e.tokenImages}}))}firstUpdated(){a.aG.getAvailableCurrencies()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const e=this.selectedCurrency?.symbol||"",t=this.currencyImages[e]||this.tokenImages[e];return r.qy`<wui-input-text type="number" size="lg" value=${this.value}>
    ...
    </wui-input-text>`}formatPaymentCurrency(e){return{name:e.id,symbol:e.id}}formatPurchaseCurrency(e){return{name:e.name,symbol:e.symbol}}};z.styles=H,L([(0,o.MZ)({type:String})],z.prototype,"type",void 0),L([(0,o.MZ)({type:Number})],z.prototype,"value",void 0),L([(0,o.wk)()],z.prototype,"currencies",void 0),L([(0,o.wk)()],z.prototype,"selectedCurrency",void 0),L([(0,o.wk)()],z.prototype,"currencyImages",void 0),L([(0,o.wk)()],z.prototype,"tokenImages",void 0),z=L([(0,p.EM)("w3m-onramp-input")],z);const N=r.AH`
  :host > wui-flex {
    width: 100%;
    max-width: 360px;
  }
...
`;var _=function(e,t,i,r){var o,s=arguments.length,a=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,i,r);else for(var n=e.length-1;n>=0;n--)(o=e[n])&&(a=(s<3?o(a):s>3?o(t,i,a):o(t,i))||a);return s>3&&a&&Object.defineProperty(t,i,a),a};const K={USD:"$",EUR:"€",GBP:"£"},Z=[100,250,500,1e3];let J=class extends r.WF{constructor(){super(),this.unsubscribe=[],this.disabled=!1,this.caipAddress=m.W.state.activeCaipAddress,this.loading=u.W.state.loading,this.paymentCurrency=a.aG.state.paymentCurrency,this.paymentAmount=a.aG.state.paymentAmount,this.purchaseAmount=a.aG.state.purchaseAmount,this.quoteLoading=a.aG.state.quotesLoading,this.unsubscribe.push(m.W.subscribeKey("activeCaipAddress",e=>this.caipAddress=e),u.W.subscribeKey("loading",e=>{this.loading=e}),a.aG.subscribe(e=>{this.paymentCurrency=e.paymentCurrency,this.paymentAmount=e.paymentAmount,this.purchaseAmount=e.purchaseAmount,this.quoteLoading=e.quotesLoading}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return r.qy`
    ...
    `}templateButton(){return this.caipAddress?r.qy`<wui-button
        ...
        >
          Connect wallet
        </wui-button>`}getQuotes(){this.loading||u.W.open({view:"OnRampProviders"})}openModal(){u.W.open({view:"Connect"})}async onPaymentAmountChange(e){a.aG.setPaymentAmount(Number(e.detail)),await a.aG.getQuote()}async selectPresetAmount(e){a.aG.setPaymentAmount(e),await a.aG.getQuote()}};J.styles=N,_([(0,o.MZ)({type:Boolean})],J.prototype,"disabled",void 0),_([(0,o.wk)()],J.prototype,"caipAddress",void 0),_([(0,o.wk)()],J.prototype,"loading",void 0),_([(0,o.wk)()],J.prototype,"paymentCurrency",void 0),_([(0,o.wk)()],J.prototype,"paymentAmount",void 0),_([(0,o.wk)()],J.prototype,"purchaseAmount",void 0),_([(0,o.wk)()],J.prototype,"quoteLoading",void 0),J=_([(0,p.EM)("w3m-onramp-widget")],J)},93516(e,t,i){i(36887)}}]);